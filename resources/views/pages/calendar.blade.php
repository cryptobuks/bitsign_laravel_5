	...
	<div class="relative">
		<div class="calendar-container transition">
			...
			<div class="view-year">
				...
				<div class="grid">
					<div id="gen" class="month-item transition"><span class="centred">JAN</span></div>
					<div id="feb" class="month-item transition"><span class="centred">FEB</span></div>
					<div id="mar" class="month-item transition"><span class="centred">MAR</span></div>
					...
					<div id="aug" class="month-item transition"><span class="centred current">AUG</span></div>
